...
export default function StateRegistryPage() {
  ...
  const states = [
    ...
    { state: "Minnesota", region: "Midwest", status: "Standard Column Layout", format: "CSV", cost: "$46 Statewide", notes: "Multi-family occupancy playbook pre-configured for high-density network checks.", link: "https://www.sos.state.mn.us/elections-voting/" },
    ...
    { state: "Oklahoma", region: "Southwest", status: "Standard Column Layout", format: "CSV / ZIP", cost: "Free Online Request", notes: "Clean header structure. Ready for local-compute playbook testing.", link: "https://oklahoma.gov/elections/" },
