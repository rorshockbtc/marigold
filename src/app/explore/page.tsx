...
export default function ExplorePage() {
  ...
  const renderDataPanel = () => {
    ...
    return (
      <div className="w-96 bg-white border-l border-border-soft shadow-xl h-full p-6 overflow-y-auto flex-shrink-0 animate-in slide-in-from-right-8">
        ...
        {/* READ-ONLY / SANDBOX DEGRADATION LOGIC */}
        <div className="space-y-3 mb-8 pt-4 border-t border-border-soft">
          {!isGroupSynced ? (
            <>
              {/* UX Fix: Replaced "Desync" and technical jargon with friendly copy */}
