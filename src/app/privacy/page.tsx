      ...
      <div className="max-w-4xl mx-auto bg-slate-50 border border-slate-200 border border-slate-200 rounded-3xl p-8 sm:p-12 shadow-2xl space-y-8">
        ...
        <div className="space-y-6 text-sm text-slate-700 leading-relaxed">
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900 uppercase tracking-wider">1. The Zero-Cloud PII Guarantee</h2>
            <p>
          ...
          <section className="space-y-3 bg-emerald-950/40 border border-emerald-500/30 p-5 rounded-2xl">
            <h2 className="text-lg font-bold text-emerald-700 uppercase tracking-wider">2. How Shared Playbooks Work Without Leaking Data</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900 uppercase tracking-wider">3. Account Authentication &amp; Metadata</h2>
            <p>
