    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans pb-24 selection:bg-amber-500 selection:text-slate-950">
      ...
      <section className="relative w-full py-32 md:py-48 px-6 text-center overflow-hidden border-b border-slate-800">
        ...
        <div className="relative z-10 max-w-4xl mx-auto space-y-6">
          ...
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-black tracking-tight text-white drop-shadow-sm">
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-slate-900/60 border border-slate-800 rounded-3xl p-8 space-y-4 hover:border-slate-700 transition-colors shadow-lg">
            <div className="w-12 h-12 rounded-2xl bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-2xl">
              🔔
            </div>
            <h3 className="text-xl font-bold text-white">Proclaim Liberty & Verification</h3>
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-3xl p-8 space-y-4 hover:border-slate-700 transition-colors shadow-lg">
            ...
            <h3 className="text-xl font-bold text-white">Bridging the Partisan Divide</h3>
            <p className="text-slate-400 text-sm leading-relaxed">
      ...
      <section className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-gradient-to-r from-slate-900 via-slate-900/90 to-slate-900 border border-slate-800 rounded-3xl p-8 sm:p-12 relative overflow-hidden shadow-2xl">
