...
export default function CookiesPage() {
  return (
    <div className="min-h-screen bg-slate-100 text-slate-100 py-16 px-4 font-sans">
      <div className="max-w-4xl mx-auto bg-slate-50 border border-slate-200 border border-slate-200 rounded-3xl p-8 sm:p-12 shadow-2xl space-y-8">
        ...
        <div className="space-y-6 text-sm text-slate-700 leading-relaxed">
          <section className="space-y-3 bg-emerald-950/40 border border-emerald-500/30 p-5 rounded-2xl">
            <h2 className="text-lg font-bold text-emerald-700 uppercase tracking-wider">1. The Zero-Tracking Guarantee</h2>
            <p className="text-slate-200">
              Marigold Insights is engineered from the ground up for strict government and civic compliance. <strong className="text-slate-900 font-bold">We use ZERO third-party advertising, marketing, behavioral profiling, or cross-site surveillance cookies.</strong>
            </p>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900 uppercase tracking-wider">2. Strictly Necessary Authentication Cookies</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900 uppercase tracking-wider">3. Local Browser Storage &amp; IndexedDB Architecture</h2>
            <p>
            ...
            <div className="grid md:grid-cols-2 gap-4 pt-2">
              <div className="bg-slate-100 p-5 rounded-xl border border-slate-200 space-y-2">
                ...
                <h3 className="font-serif font-bold text-slate-900 text-base">User Preferences &amp; Playbooks</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
                  We store your custom column header mappings (<code className="text-slate-700">marigold_file_mapping</code>), custom anomaly detection playbooks, and UI state preferences locally on your hard drive so you do not have to re-configure your workspace between sessions.
                </p>
              </div>
              <div className="bg-slate-100 p-5 rounded-xl border border-slate-200 space-y-2">
                <span className="font-mono font-bold text-[11px] bg-sky-900/60 text-sky-300 px-2 py-0.5 rounded">INDEXEDDB</span>
                <h3 className="font-serif font-bold text-slate-900 text-base">Local Civic Dataset Engine</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
                  When you ingest a state voter roll or municipal spreadsheet, the records are stored inside an isolated local database (<code className="text-slate-700">MarigoldDB</code>) within your browser&apos;s sandbox. This data never leaves your computer and is never transmitted to our cloud servers.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900 uppercase tracking-wider">4. Data Destruction &amp; Sanitization Protocol</h2>
            <p>
              State election statutes and municipal IT standards require strict data sanitization and disposal schedules for citizen rolls. Because Marigold Insights processes datasets entirely within your local browser memory and IndexedDB sandbox, <strong className="text-emerald-700 font-bold">you retain 100% control over data destruction</strong>.
            </p>
            <p>
              To permanently destroy and purge all ingested civic records from your machine, simply click the <strong className="text-slate-900">&quot;Clear Workspace Data&quot;</strong> button in our data preparation tab or clear your browser&apos;s site data/cache. Upon action, your browser instantaneously sanitizes and frees the local memory sectors, satisfying state data destruction requirements without needing third-party vendor certificates.
            </p>
          </section>
        </div>
        ...
        <div className="pt-6 border-t border-slate-200 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <Link href="/compliance" className="bg-primary hover:bg-slate-800 text-slate-900 font-bold px-6 py-3 rounded-xl text-xs transition-colors">
