      ...
      <div className="max-w-4xl mx-auto bg-slate-50 border border-slate-200 border border-slate-200 rounded-3xl p-8 sm:p-12 shadow-2xl space-y-8">
        ...
        <div className="space-y-6 text-sm text-slate-700 leading-relaxed">
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900 uppercase tracking-wider">1. Our Commitment to Equal Civic Access</h2>
            ...
            <p>
              We design and engineer our digital workspace in strict accordance with <strong className="text-slate-900 font-bold">Section 508 of the Rehabilitation Act (29 U.S.C. 794d)</strong> and the <strong className="text-slate-900 font-bold">Web Content Accessibility Guidelines (WCAG) 2.1 Level AA</strong> published by the World Wide Web Consortium (W3C).
            </p>
          </section>
          ...
          <section className="grid md:grid-cols-2 gap-4 pt-2">
            <div className="bg-slate-100 p-5 rounded-xl border border-slate-200 space-y-2">
              <div className="flex items-center gap-2 text-amber-400 font-bold">
                ...
                <h3 className="font-serif text-slate-900 text-base">Full Keyboard Navigability</h3>
              </div>
            ...
            <div className="bg-slate-100 p-5 rounded-xl border border-slate-200 space-y-2">
              <div className="flex items-center gap-2 text-emerald-700 font-bold">
                ...
                <h3 className="font-serif text-slate-900 text-base">High Contrast &amp; Visual Clarity</h3>
              </div>
              <p className="text-xs text-slate-600 leading-relaxed">
          ...
          <section className="space-y-3 pt-2">
            <h2 className="text-lg font-bold text-slate-900 uppercase tracking-wider">2. Screen Reader &amp; Assistive Technology Parity</h2>
            <p>
            ...
            <ul className="list-disc list-inside space-y-1.5 pl-2 text-slate-700">
              <li><strong className="text-slate-900">Descriptive ARIA Labels:</strong> Dynamic anomaly badges, progress bars, and risk severity indicators are announced cleanly to assistive devices.</li>
              <li><strong className="text-slate-900">Structured Data Tables:</strong> Voter roll anomaly results utilize strict header associations (<code className="text-xs bg-slate-800 px-1 py-0.5 rounded">&lt;th scope=&quot;col&quot;&gt;</code>) so screen reader users can effortlessly traverse multi-thousand-row reports.</li>
              <li><strong className="text-slate-900">Focus Management:</strong> When opening side sheets or anomaly investigation drawers, keyboard focus is automatically trapped within the active dialog and restored upon closure.</li>
            </ul>
          </section>

          <section className="space-y-3 bg-slate-100/80 border border-slate-200 p-5 rounded-2xl">
            <div className="flex items-center gap-2 text-sky-400 font-bold">
              <ShieldCheck className="w-5 h-5" />
              <h2 className="text-base font-bold uppercase tracking-wider text-slate-900">3. Continuous Auditing &amp; Quality Assurance</h2>
            </div>
          ...
          <section className="space-y-3">
            <div className="flex items-center gap-2 text-amber-400 font-bold">
              ...
              <h2 className="text-lg font-bold text-slate-900 uppercase tracking-wider">4. Accommodation Requests &amp; Feedback</h2>
            </div>
            <p>
            ...
            <div className="bg-slate-100 p-4 rounded-xl border border-slate-200 inline-block">
              <span className="text-xs text-slate-600 block">Accessibility &amp; Section 508 Coordinator:</span>
