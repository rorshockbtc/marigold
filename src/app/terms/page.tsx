      ...
      <div className="max-w-4xl mx-auto bg-slate-900 border border-slate-800 rounded-3xl p-8 sm:p-12 shadow-2xl space-y-8">
        ...
        <div className="space-y-6 text-sm text-slate-300 leading-relaxed">
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-white uppercase tracking-wider">1. Acceptance of Terms &amp; Zero-Trust Protocol Architecture</h2>
            <p>
          ...
          <section className="space-y-3 bg-slate-950/80 border border-amber-500/30 p-5 rounded-2xl">
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-white uppercase tracking-wider">3. Strict Prohibition on Commercial &amp; Unlawful Use</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-white uppercase tracking-wider">4. Indemnification</h2>
            <p>
